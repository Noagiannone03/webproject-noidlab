...
silktideCookieBannerManager.updateCookieBannerConfig({
  ...
  text: {
    banner: {
      description: "<p>Nous utilisons des cookies sur notre site afin d'améliorer votre expérience utilisateur, de fournir un contenu personnalisé et d'analyser notre trafic.. <a href=\"https://your-website.com/cookie-policy\" target=\"_blank\">Cookie Policy.</a></p>",
